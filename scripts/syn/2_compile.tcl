...
# Although it's strange, using the "-exact_map -no_autoungroup -no_seq_output_inversion -no_boundary_optimization" options achieves better PPA than the default "compile_ultra" without any options.
# It seems that the ASAP 7nm library does not include clocked gates...
